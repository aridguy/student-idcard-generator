                            ...
                            <div className="col-md-4">
                                ...
                                <form >
                                    <div className="formFiller gap-2">
                                        <input type="text" className="form-control name" placeholder="full name" onChange={handleChangeName} />
                                        <input type="text" className="form-control designation mt-3" placeholder="student" onChange={handleChangeDesig} />
                                        <input type="text" className="form-control studentNo mt-3" placeholder="LASG N0" onChange={handleChangeStdntNo} />
                                        <input type="text" className="form-control dept mt-3" placeholder="department" onChange={handleChangeDept} />
                                        <input type="text" className="form-control expDate mt-3" value='DECEMBER, 2023' onChange={handleChangeExp} />
                                        <input type="text" className="form-control signature mt-3" />
                                            ...
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="text-center">
                                                        <span className="t1">LAGOS STATE GOVERNMENT</span> <br />
                                                        <span className="t2">MINISTRY OF WOMEN AFFAIRS & POVERTY ALLEVIATION</span><br />
                                                        <span className="t3">WOMEN DEVELOPMENT CENTRE AGEGE</span><br />
                                                        <span className="t4">OBA-OGUNJI ROAD, PEN-CINEMA AGEGE, LAGOS</span><br />
                                                ...
                                                <div className="d-flex">
                                                    ...
                                                    <div>
                                                        <div className="userDetails">
                                                            <ul className="ul">
                                                                <li><input type="text" className="d-forms" placeholder='ARIYO IDOWU ROTIMI' value={inputValueName} /></li>
                                                                <li><input type="text" className="d-forms" placeholder='STUDENT' value={inputValueDesig} /></li>
                                                                <li><input type="text" className="d-forms" placeholder='LASG/WDC/CTO/123' value={inputValueStdntNo} /></li>
                                                                <li><input type="text" className="d-forms" placeholder='SEWING & FASHION' value={inputValueDept} /></li>
                                                                <li><input type="text" className="d-forms" placeholder='DECEMBER, 2023' value={inputValueExp} /></li>
                                                                <li><input type="text" className="d-forms signs"npm />
                                                                    <img className="passportSmall" src={Passport} alt='passport' />
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
